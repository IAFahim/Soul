...
namespace Soul.Model.Runtime.Limits
{
    ...
    public struct LimitIntStruct
    {
        ...
        public static implicit operator int(LimitIntStruct limitInt) => limitInt.Current;
        public static implicit operator float(LimitIntStruct limitInt) => (float)limitInt.Current / limitInt.Max;
